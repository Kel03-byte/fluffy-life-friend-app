...
import Kitten from './pages/cat-viewing-pages/kitten-page';
import Adult from './pages/cat-viewing-pages/adult-cat-page';
import Senior from './pages/cat-viewing-pages/senior-cat-page';
